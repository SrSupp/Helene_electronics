#ifndef _ROS_lcr_controller_jointPosition_h
#define _ROS_lcr_controller_jointPosition_h
...
namespace lcr_controller
{
  ...
  class jointPosition : public ros::Msg
  {
    ...
    const char * getType(){ return "lcr_controller/jointPosition"; };
    const char * getMD5(){ return "956f1cde90e807d13d6f744edcd8a099"; };
